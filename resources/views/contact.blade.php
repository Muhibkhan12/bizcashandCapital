...
<head>
    ...
    <style>
        * {
        ...
        .contact-card:hover { transform: translateY(-4px); box-shadow: 0 15px 30px -12px rgba(26,122,74,0.15); border-color: #1a7a4a; }
        ...
        nav.scrolled { border-bottom-color: #1a7a4a; }
    </style>
</head>
<body>
                    ...
                    <div style="display: flex; gap: 1rem;">
                        <a href="#" style="width: 44px; height: 44px; background: #e8f0e8; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; border-radius: 0 !important;"
                           ...
                           onmouseout="this.style.background='#e8f0e8'; this.querySelector('svg').style.stroke='#1a7a4a';">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a7a4a" stroke-width="2"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg>
                        </a>
                        <a href="#" style="width: 44px; height: 44px; background: #e8f0e8; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;"
                           onmouseover="this.style.background='#1a7a4a'; this.querySelector('svg').style.stroke='white';"
                           onmouseout="this.style.background='#e8f0e8'; this.querySelector('svg').style.stroke='#1a7a4a';">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a7a4a" stroke-width="2"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"/></svg>
                        </a>
                        <a href="#" style="width: 44px; height: 44px; background: #e8f0e8; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;"
                           onmouseover="this.style.background='#1a7a4a'; this.querySelector('svg').style.stroke='white';"
                           onmouseout="this.style.background='#e8f0e8'; this.querySelector('svg').style.stroke='#1a7a4a';">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a7a4a" stroke-width="2"><rect x="2" y="2" width="20" height="20" rx="4" ry="4"/><circle cx="12" cy="12" r="4"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>
                        </a>
                        <a href="#" style="width: 44px; height: 44px; background: #e8f0e8; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease;"
                           onmouseover="this.style.background='#1a7a4a'; this.querySelector('svg').style.stroke='white';"
                           onmouseout="this.style.background='#e8f0e8'; this.querySelector('svg').style.stroke='#1a7a4a';">
                            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#1a7a4a" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg>
                        </a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    <section style="padding: 0; background: #1a2a1a; position: relative; overflow: hidden;">
        <div style="position: relative; height: 400px; background: #2a3a2a;">
            <!-- Simple Map Representation -->
            <div style="position: absolute; inset: 0; background: linear-gradient(135deg, #1a7a4a20, #0f5a3820);"></div>
            <div style="position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%); text-align: center; color: white; z-index: 2;">
                <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#c8e86a" stroke-width="1.5">
                    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/>
                    <circle cx="12" cy="10" r="3"/>
                </svg>
                <p style="margin-top: 1rem; font-size: 1.125rem; font-weight: 500;">Cleveland, Ohio — Serving businesses nationwide</p>
            </div>
            <!-- Map Overlay Pattern -->
            <div style="position: absolute; inset: 0; background-image: radial-gradient(circle at 25% 40%, #c8e86a 1px, transparent 1px); background-size: 40px 40px; opacity: 0.05;"></div>
        </div>
    </section>
    ...
    <!-- CTA Section -->
    <section style="padding: 4rem 0; background: #1a7a4a; position: relative; overflow: hidden;">
        ...
        <div style="max-width: 1280px; margin: 0 auto; padding: 0 2rem; text-align: center; position: relative; z-index: 2;">
            <h2 style="font-size: 2rem; font-weight: 800; color: white; margin-bottom: 1rem;">Ready to grow your business?</h2>
            <p style="color: rgba(255,255,255,0.8); margin-bottom: 1.5rem;">Start your loan application today. Our team is ready to help you succeed.</p>
            <button class="btn-outline" style="border-color: white; color: white; background: transparent;" onmouseover="this.style.background='white'; this.style.color='#1a7a4a';" onmouseout="this.style.background='transparent'; this.style.color='white';">Apply Now →</button>
        </div>
    </section>
    ...
    <style>
        ...
        .contact-card:hover svg { animation: pulse 1s ease-in-out; }
    </style>
