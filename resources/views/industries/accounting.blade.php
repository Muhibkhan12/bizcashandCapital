...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .card { 
            transition: all 0.3s ease; cursor: pointer; border: 1px solid rgba(255,255,255,0.1); 
            border-radius: 0 !important; 
        }
        .card:hover { transform: translateY(-6px); box-shadow: 0 20px 35px -12px rgba(26,122,74,0.3); border-color: #c8e86a; }
        
        .benefit-card { 
            transition: all 0.3s ease; background: white; border: 1px solid #e2e8e2; 
            border-radius: 0 !important; 
        }
...
@include('header')
    ...
    <section class="relative h-[75vh] min-h-[500px] md:h-[80vh] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-5 lg:px-8 w-full text-center">
            <h1 class="font-grotesk text-[clamp(42px,10vw,85px)] leading-[1.1] tracking-tight text-white mb-4">Accounting Firm Funding</h1>
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-4 font-grotesk">The Importance of<br>Funding for Accounting Firms</h2>
    ...
    <!-- Accounting Firm Funding Options Section - 8 cards -->
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3 font-grotesk">Accounting Firm Funding Options</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Working Capital Loans</h3><p class="text-white/80 text-sm">Cover day-to-day expenses, hire staff, manage cash flow fluctuations. Ensure financial stability.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Business Expansion Loans -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Business Expansion Loans</h3><p class="text-white/80 text-sm">Expand practice, open new branches, invest in marketing campaigns for broader clientele.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Technology and Software Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Technology & Software Financing</h3><p class="text-white/80 text-sm">Upgrade hardware, software, IT solutions. Stay ahead in digital landscape.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Mergers and Acquisitions Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Mergers & Acquisitions</h3><p class="text-white/80 text-sm">Specialized financing for merging with or acquiring another accounting firm.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Debt Consolidation Loans -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1554224155-6726b3ff858f?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Debt Consolidation Loans</h3><p class="text-white/80 text-sm">Streamline finances, simplify debt management, lower interest rates.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Account Receivables Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Account Receivables Financing</h3><p class="text-white/80 text-sm">Optimize cash flow by leveraging outstanding payments from clients.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Tax Season Preparation Loans -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 22v-4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><path d="M12 8v8M8 12h8"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Tax Season Preparation Loans</h3><p class="text-white/80 text-sm">Cover temporary staffing, marketing, operational expenses during busy tax season.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
                <!-- Professional Development Funding -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1556745753-b2904692b3cd?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Professional Development Funding</h3><p class="text-white/80 text-sm">Invest in continuous education, skill development, and team expertise.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a] hover:text-white transition">Learn More →</a><a href="#" class="text-[#c8e86a] hover:text-white transition">Contact Experts →</a></div></div></div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10"><div class="tag inline-flex"><span></span>KEY BENEFITS</div><h2 class="text-3xl md:text-4xl font-extrabold mt-3 font-grotesk">Key Benefits of Accounting Firm Funding</h2><div class="w-20 h-1 bg-gradient-to-r from-[#1a7a4a] to-[#c8e86a] mx-auto my-4"></div></div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3 class="font-bold text-md font-grotesk">Competitive Edge & Innovation</h3><p class="text-gray-500 text-xs">Stay ahead by investing in innovative practices and technologies.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3 class="font-bold text-md font-grotesk">Technology Advancements</h3><p class="text-gray-500 text-xs">Cutting-edge software, automation, and data analytics platforms.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><h3 class="font-bold text-md font-grotesk">Talent Attraction & Retention</h3><p class="text-gray-500 text-xs">Attract top professionals with competitive compensation.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div><h3 class="font-bold text-md font-grotesk">Service Diversification</h3><p class="text-gray-500 text-xs">Expand into advisory, forensic accounting, or wealth management.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="font-bold text-md font-grotesk">Marketing & Branding</h3><p class="text-gray-500 text-xs">Increase firm visibility and attract new clients.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="font-bold text-md font-grotesk">Regulatory Compliance</h3><p class="text-gray-500 text-xs">Resources to adapt and comply with changing accounting standards.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div><h3 class="font-bold text-md font-grotesk">Client Trust & Confidence</h3><p class="text-gray-500 text-xs">Demonstrate financial stability and capability.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="font-bold text-md font-grotesk">Risk Mitigation</h3><p class="text-gray-500 text-xs">Manage financial risks and ensure business continuity.</p></div>
            </div>
        </div>
    </section>
