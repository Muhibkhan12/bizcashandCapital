...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        ::-webkit-scrollbar-thumb { background: #1a7a4a; border-radius: 0; }
...
@include('header')
    ...
    <!-- Hero Section - Fully responsive height with mobile adjustments -->
    <section class="relative h-[80vh] min-h-[500px] md:h-[85vh] md:min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 w-full text-center">
            <h1 class="font-jakarta text-[clamp(42px,10vw,80px)] leading-[1.1] tracking-tight text-white mb-4">Cleaning Business Funding</h1>
            <div class="w-20 h-1 bg-gradient-to-r from-lime-400 to-emerald-500 mx-auto mb-6"></div>
            ...
            <div class="flex gap-4 justify-center flex-wrap mt-8">
                <a href="#" class="inline-flex items-center gap-2 bg-emerald-600 hover:bg-emerald-500 text-white px-6 py-3 sm:px-8 sm:py-3.5 font-semibold text-sm transition-all duration-300">Get Started Now →</a>
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-4">The Importance of<br>Funding for Cleaning Businesses</h2>
    ...
    <!-- Cleaning Business Funding Options Section - fully responsive grid (2 on tablet, 1 on mobile) -->
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3">Cleaning Business Funding Options</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <!-- Lines of Credit -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden rounded-none" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div>
                            <div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div>
                            <h3 class="text-xl font-bold mb-2">Lines of Credit</h3>
                        ...
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300 hover:underline">Leave a Feedback →</a><a href="#" class="text-lime-300 hover:underline">Contact Experts →</a></div>
                    </div>
                </div>
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div><div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="text-xl font-bold mb-2">Crowdfunding</h3><p class="text-white/80 text-sm">Utilize online platforms to raise funds from many people interested in supporting your cleaning business.</p></div>
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300">Leave a Feedback →</a><a href="#" class="text-lime-300">Contact Experts →</a></div>
                    </div>
                </div>
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div><div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 10h18M6 14h2m8 0h2M7 18h10M5 22h14a2 2 0 002-2V4a2 2 0 00-2-2H5a2 2 0 00-2 2v16a2 2 0 002 2z"/></svg></div><h3 class="text-xl font-bold mb-2">Merchant Cash Advances</h3><p class="text-white/80 text-sm">Quick access to funds based on credit card sales. Swift solution for immediate financial needs.</p></div>
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300">Leave a Feedback →</a><a href="#" class="text-lime-300">Contact Experts →</a></div>
                    </div>
                </div>
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div><div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="text-xl font-bold mb-2">Business Loans</h3><p class="text-white/80 text-sm">Lump sum amount for upgrading equipment, expanding services, or hiring staff.</p></div>
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300">Leave a Feedback →</a><a href="#" class="text-lime-300">Contact Experts →</a></div>
                    </div>
                </div>
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div><div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3 class="text-xl font-bold mb-2">Equipment Financing</h3><p class="text-white/80 text-sm">Acquire latest cleaning equipment without significant upfront payment. Equipment serves as collateral.</p></div>
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300">Leave a Feedback →</a><a href="#" class="text-lime-300">Contact Experts →</a></div>
                    </div>
                </div>
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=500&fit=crop');">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-emerald-800/70 z-10"></div>
                    <div class="relative z-20 p-6 flex flex-col justify-between h-full text-white">
                        <div><div class="w-12 h-12 bg-emerald-700 flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="text-xl font-bold mb-2">Peer-to-Peer Lending</h3><p class="text-white/80 text-sm">Connect with individual lenders, alternative to traditional loans with competitive rates.</p></div>
                        <div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-lime-300">Leave a Feedback →</a><a href="#" class="text-lime-300">Contact Experts →</a></div>
                    </div>
                </div>
            </div>
    ...
    <!-- Support Your Cleaning Business Firm Section - responsive two cols -->
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div class="order-1 lg:order-2">
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-3">Support Your<br>Cleaning Business Firm</h2>
                    <div class="w-16 h-1 bg-gradient-to-r from-emerald-700 to-lime-400 mb-5"></div>
                    ...
                    <a href="tel:+12166470007" class="text-emerald-700 font-bold text-lg inline-block">+1 (216) 647-0007</a>
                </div>
            </div>
        </div>
    </section>

    <!-- Key Benefits - responsive grid (1,2,3 columns) -->
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10">
                <div class="tag inline-flex"><span></span>KEY BENEFITS</div>
                <h2 class="text-3xl md:text-4xl font-extrabold mt-3">Key Benefits of Cleaning Business Funding</h2>
                <div class="w-20 h-1 bg-gradient-to-r from-emerald-700 to-lime-400 mx-auto my-4"></div>
            </div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="font-bold text-md">High-Quality Equipment</h3><p class="text-gray-500 text-xs">Upgrade to latest cleaning technology for efficiency.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><h3 class="font-bold text-md">Attract & Retain Talent</h3><p class="text-gray-500 text-xs">Competitive wages, staff training for reliability.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="font-bold text-md">Eco-Friendly Solutions</h3><p class="text-gray-500 text-xs">Attract eco-conscious clients with green products.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div><h3 class="font-bold text-md">Diversify Services</h3><p class="text-gray-500 text-xs">Expand into specialized cleaning, more revenue.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div><h3 class="font-bold text-md">Adopt Technology</h3><p class="text-gray-500 text-xs">Scheduling software, route optimization tools.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3 class="font-bold text-md">Market & Brand</h3><p class="text-gray-500 text-xs">Ad campaigns & branding to reach clients.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="font-bold text-md">Adapt to Trends</h3><p class="text-gray-500 text-xs">Stay flexible, seasonal & market changes.</p></div>
                <div class="bg-white border border-gray-100 p-5 text-center benefit-card"><div class="w-14 h-14 bg-emerald-700 flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div><h3 class="font-bold text-md">Working Capital</h3><p class="text-gray-500 text-xs">Healthy cash flow for payroll & operations.</p></div>
            </div>
        </div>
    </section>
