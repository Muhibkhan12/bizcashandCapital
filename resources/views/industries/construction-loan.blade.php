...
@include('header')
    ...
    <section class="relative min-h-[550px] md:min-h-[600px] flex items-center justify-center overflow-hidden pt-24 md:pt-28 pb-12 md:pb-16">
        ...
        <div class="relative z-20 max-w-7xl mx-auto px-5 lg:px-8 w-full text-center">
            <h1 class="font-grotesk text-[clamp(42px,10vw,85px)] leading-[1.1] tracking-tight text-white mb-4">Construction Industry Funding</h1>
        ...
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <h2 class="text-3xl md:text-4xl font-extrabold mb-4 font-grotesk">The Significance of<br>Funding for Construction Industry</h2>
    ...
    <!-- Construction Industry Funding Options Section - FULL GRID (9 items) -->
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10">
                ...
                <h2 class="text-3xl md:text-4xl font-extrabold text-gray-800 mb-3 font-grotesk">Construction Industry Funding Options</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Equipment Financing</h3><p class="text-white/80 text-sm">Secure funding specifically for acquiring construction equipment and machinery without significant upfront payment.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 2 Project-Based Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/><path d="M9 22V12h6v10"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Project-Based Financing</h3><p class="text-white/80 text-sm">Tailored funding for specific projects, covering labor, materials, permits, and related expenses.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 3 Working Capital Loans -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Working Capital Loans</h3><p class="text-white/80 text-sm">Short-term loans for payroll, material purchases, utilities, ensuring smooth project execution.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 4 Contract Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1450101499163-c8848c66ca85?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Contract Financing</h3><p class="text-white/80 text-sm">Funding based on approved contracts, unlocking capital tied to specific projects.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 5 Construction Factoring -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1563013544-824ae1b704d3?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Construction Factoring</h3><p class="text-white/80 text-sm">Sell accounts receivable for immediate cash, covering project costs and operational expenses.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 6 Lines of Credit for Contractors -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1444653614773-995cb1ef9efa?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Lines of Credit for Contractors</h3><p class="text-white/80 text-sm">Flexible revolving credit, draw funds as needed for financial stability and unexpected expenses.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 7 Bridge Loans for Real Estate Development -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 22v-4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83M2 12h4M18 12h4"/><path d="M12 8v8M8 12h8"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Bridge Loans for Real Estate</h3><p class="text-white/80 text-sm">Short-term loans bridging gap between property acquisition and long-term financing.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 8 Construction Management Software Financing -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Construction Software Financing</h3><p class="text-white/80 text-sm">Funds for acquiring management software to streamline planning and execution.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
                <!-- 9 Invoice Financing for Contractors -->
                <div class="card bg-cover bg-center min-h-[400px] relative overflow-hidden" style="background-image: url('https://images.unsplash.com/photo-1581092335871-44c27de6f9f2?w=600&h=500&fit=crop');"><div class="absolute inset-0 bg-gradient-to-t from-black/80 via-black/60 to-[#1a7a4a]/70 z-10"></div><div class="relative z-20 p-6 flex flex-col justify-between h-full text-white"><div><div class="w-12 h-12 bg-[#1a7a4a] flex items-center justify-center mb-4"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M21 12v4a4 4 0 01-4 4H7a4 4 0 01-4-4v-4M3 8h18"/></svg></div><h3 class="text-xl font-bold mb-2 font-grotesk">Invoice Financing</h3><p class="text-white/80 text-sm">Advance on outstanding invoices to improve cash flow during project cycles.</p></div><div class="mt-5 pt-4 border-t border-white/20 flex justify-between text-xs"><a href="#" class="text-[#c8e86a]">Learn More →</a><a href="#" class="text-[#c8e86a]">Contact Experts →</a></div></div></div>
            </div>
        </div>
    </section>
    ...
    <section style="padding: 4rem 0; background: #f5f7f5;" class="scroll-reveal">
        <div class="max-w-7xl mx-auto px-5 md:px-8">
            <div class="text-center mb-10"><div class="tag inline-flex"><span></span>KEY BENEFITS</div><h2 class="text-3xl md:text-4xl font-extrabold mt-3 font-grotesk">Key Benefits of Construction Company Funding</h2><div class="w-20 h-1 bg-gradient-to-r from-[#1a7a4a] to-[#c8e86a] mx-auto my-4"></div></div>
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg></div><h3 class="font-bold text-md font-grotesk">Project Scaling & Expansion</h3><p class="text-gray-500 text-xs">Access capital to take on larger projects and expand your business.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div><h3 class="font-bold text-md font-grotesk">Equipment & Tech Investment</h3><p class="text-gray-500 text-xs">State-of-the-art machinery, improving efficiency and competitiveness.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2v4M12 18v4M4.93 4.93l2.83 2.83M16.24 16.24l2.83 2.83"/><circle cx="12" cy="12" r="3"/></svg></div><h3 class="font-bold text-md font-grotesk">Working Capital Mgmt</h3><p class="text-gray-500 text-xs">Healthy cash flow for payroll, materials, daily operations.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M3 6h18M8 6V4h8v2M6 10h12M5 18h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/></svg></div><h3 class="font-bold text-md font-grotesk">Competitive Bidding</h3><p class="text-gray-500 text-xs">Submit confident bids with proper financial backing.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg></div><h3 class="font-bold text-md font-grotesk">Cash Flow Stabilization</h3><p class="text-gray-500 text-xs">Stabilize during slow seasons or between project payments.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M12 8v4M12 16h.01"/></svg></div><h3 class="font-bold text-md font-grotesk">Risk Mitigation</h3><p class="text-gray-500 text-xs">Manage financial risks from project delays or costs.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg></div><h3 class="font-bold text-md font-grotesk">Supplier Relationships</h3><p class="text-gray-500 text-xs">Timely payments foster better partnerships.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg></div><h3 class="font-bold text-md font-grotesk">Market Agility</h3><p class="text-gray-500 text-xs">Respond quickly to market changes and opportunities.</p></div>
                <div class="benefit-card p-5 text-center"><div class="w-14 h-14 bg-[#1a7a4a] flex items-center justify-center mx-auto mb-3"><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" stroke-width="2"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/></svg></div><h3 class="font-bold text-md font-grotesk">Credit Building</h3><p class="text-gray-500 text-xs">Build business credit for future financing options.</p></div>
            </div>
        </div>
    </section>
